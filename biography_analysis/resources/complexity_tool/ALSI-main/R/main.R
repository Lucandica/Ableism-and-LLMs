...
corpus_dir <- "corpus/biographies/"  # this folder should contain your text files in .txt format
...
saveRDS(features, "out/biographies_corpus_with_features.Rds")

# If you want just the features (no parsed corpus),
features_without_corpus <- features
features_without_corpus$parsed_corpus <- NULL

saveRDS(features_without_corpus, "out/biographies_features_only.Rds")
